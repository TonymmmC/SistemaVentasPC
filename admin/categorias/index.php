        ...
        switch ($_POST['accion']) {
            case 'agregar':
                ...
                if (!empty($nombre)) {
                    ...
                    if ($stmt->execute()) {
                        SessionManager::setFlashMessage('Categoría agregada correctamente', 'success');
                    } else {
                        SessionManager::setFlashMessage('Error al agregar la categoría', 'error');
                    }
                }
                break;
            ...
            case 'editar':
                ...
                if (!empty($nombre) && !empty($id)) {
                    ...
                    if ($stmt->execute()) {
                        SessionManager::setFlashMessage('Categoría actualizada correctamente', 'success');
                    } else {
                        SessionManager::setFlashMessage('Error al actualizar la categoría', 'error');
                    }
                }
                break;
            ...
            case 'eliminar':
                ...
                if ($total_productos > 0) {
                    SessionManager::setFlashMessage('No se puede eliminar la categoría porque tiene productos asociados', 'error');
                } else {
                    ...
                    if ($stmt->execute()) {
                        SessionManager::setFlashMessage('Categoría eliminada correctamente', 'success');
                    } else {
                        SessionManager::setFlashMessage('Error al eliminar la categoría', 'error');
                    }
                }
                break;
        }
                        ...
                        <tbody>
                            <?php foreach ($categorias as $categoria): ?>
                                <tr>
                                    ...
                                    <td><?php echo formatear_fecha($categoria['fecha_creacion']); ?></td>
                                    <td>
                                        ...
                                        <?php if ($categoria['total_productos'] == 0): ?>
                                            <button class="btn btn-sm btn-outline-danger" 
                                                    onclick="eliminarCategoria(<?php echo $categoria['id_categoria']; ?>, '<?php echo htmlspecialchars($categoria['nombre']); ?>')">
            ...
            <div class="modal-content">
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="id_categoria" id="delete_id">
